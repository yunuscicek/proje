...
class Pencere:
    ...
    def PencereOlustur(self, selected_text, kelimeSayisi):
        ...
        pencere.iconbitmap("./icons/ico.ico")
        ...
        text = Text(pencere, width = 45, height = 20, font = (font_type,font_size), wrap = "word")
        text.pack(padx = 5, pady = 5)
        text.config(state = DISABLED)

        ayarlar_icon = PhotoImage(file = "./icons/settings.png")
        ayarlar_buton = Button(pencere, image = ayarlar_icon, command = ay.AyarlarPencere)
        ayarlar_buton.pack()
